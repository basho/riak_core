...
%% will return {error, no_profile}, Stats will be pulled out of the
%% metadata and compared to the current status of the stats, It will
%% only enable the disabled stats and disable the enabled stats etc,
%% any unregistered stats that are saved in the profile will be ignored.
%% @end
%% -------------------------------------------------------------------
