...
-export([member_status/1, ring_status/1, print_member_status/2,
         ...
         reset_stat/1, stat_metadata/1, sanitise_stat_input/1, sanitise_stat_input/2,
         sanitise_stat_input/3, print/1, print/2, setup/1, setdown/1,
         sanitise_push_input/1, find_push_stats/1, find_push_stats/2, find_push_stats_all/1,
         fold_through_meta/3, store_setup_info/3]).
...
find_entries(Stats,Status,Type,DPs) ->
    riak_core_stats_mgr:find_entries(Stats,Status,Type,DPs).
