    ...
    {foreach,
     ...
     [
      {timeout, 60, { "trust auth works",
                      fun() ->
                              ...
                              ?assertMatch([[{username, <<"user">>}, {'member of', []},
                              ...
                              ?assertMatch([[{users, "all"}, {cidr, _},
                                             {source, "trust"}, {options, _}]],
                                           riak_core_security:format_sources()),
                              ok
                      end}},
     ...
     {timeout, 60, { "group grant/revoke on type/bucket works",
                     fun() ->
                             ...
                             ?assertMatch([[{username, <<"user">>}, {'member of', "group"},
                                            {password, _}, {options, _}]],
                                          riak_core_security:format_users()),
                             ?assertMatch([[{username, <<"user">>}, {'member of', "group"},
                                            {password, _}, {options, _}]],
                                          riak_core_security:format_user(<<"user">>)),
                              ?assertMatch([[{users, "user"}, {cidr, _},
                                             {source, "password"}, {options, _}]],
                                           riak_core_security:format_sources()),
                             ?assertMatch([[{group, <<"group">>}, {'member of', []},
                                            {options, _}]],
                     ...
                     fun() ->
                             ...
                             ?assertMatch([[{username, <<"user">>}, {'member of', []},
                              ...
                              ?assertMatch([[{users, "user"}, {cidr, _},
                                             {source, "password"}, {options, _}]],
                                           riak_core_security:format_sources()),
                             ?assertEqual([], riak_core_security:format_groups()),
     ...
     {timeout, 60, { "groups can be members of groups and inherit permissions from them",
                     fun() ->
                             ...
                             %% make sure these don't crash, at least
                             ?assertMatch([[{username, <<"user">>}, {'member of', "superuser"},
                                            {password, _}, {options, _}]],
                                          riak_core_security:format_users()),
                             ?assertMatch([[{username, <<"user">>}, {'member of', "superuser"},
                                            {password, _}, {options, _}]],
                             ...
                             ?assertMatch([[{users, "user"}, {cidr, _},
                                            {source, "password"}, {options, _}]],
                                          riak_core_security:format_sources()),
                             ?assertMatch([{_, [[{group, <<"sysadmin">>}, {type, <<"default">>},
                                                 {bucket, "*"}, {grants, "riak_kv.put, riak_kv.get"}]]},
                                           {_, []},
                                           {_, [[{type, <<"default">>}, {bucket, "*"},
                                                 {grants, "riak_kv.put, riak_kv.get"}]]}],
                                          riak_core_security:format_grants(<<"user">>)),
                             ?assertMatch([ [{group, <<"sysadmin">>}, {'member of', []}, {options, _}],
                                            [{group, <<"superuser">>}, {'member of', "sysadmin"}, {options, _}]],
                                          riak_core_security:format_groups()),
                             ?assertMatch([[{group, <<"superuser">>}, {'member of', "sysadmin"}, {options, _}]],
     ...
     {timeout, 60, { "user/group disambiguation",
                     fun() ->
                             ...
                             ?assertMatch([
                                           {_, [[{group,<<"sysadmin">>}, {type,"*"},
                                                 {bucket,"*"}, {grants,"riak_kv.put, riak_kv.get"}]]},
                                           {_, [[{type,<<"default">>}, {bucket,"*"}, {grants,"riak_kv.put, riak_kv.get"}]]},
                                           {_, [[{type,"*"}, {bucket,"*"}, {grants,"riak_kv.put, riak_kv.get"}], 
                                                [{type,<<"default">>}, {bucket,"*"}, {grants,"riak_kv.put, riak_kv.get"}]]},
                                           {_, []},
                                           {_, [[{type,"*"}, {bucket,"*"}, {grants,"riak_kv.put, riak_kv.get"}]]},
                                           {_, [[{type,"*"}, {bucket,"*"}, {grants,"riak_kv.put, riak_kv.get"}]]}] ,
                                          riak_core_security:format_grants(<<"sysadmin">>)),
                             ok
                     end}},
     {timeout, 60, { "Expected user/group errors",
                     fun() ->
                             ...
                             ?assertMatch({error, {unknown_role, _}}, riak_core_security:format_grants(<<"foo">>)),
                             ?assertEqual(ok, riak_core_security:add_user(<<"fred">>, [])),
                             ?assertMatch({error, {unknown_role, _}}, riak_core_security:format_grants(<<"group/fred">>)),
                             ok
                     end}}
    ]}.
